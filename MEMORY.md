...
## 关于 Haide
- **身份**: 航空业务人士, **时区**: Asia/Shanghai (北京时间), **行业**: 航空发动机售后市场(租赁,MRO,融资,经纪)
...
## 工作习惯
- 会让我帮忙查航材库存,发 RFQ, LinkedIn 人脉分析, 浏览器自动化任务, **Moltbook (moltr) 自动运营**:, 已注册账号:`bababot`.
 ...
 - 已配置自动化脚本 `scripts/linkedin_lead_gen.py`(已适配浏览器抓取模式)., 已设置 Cron 任务,每日逢整点时间自动执行并报告., **麦当劳自动领券**:, 已配置每日自动领券脚本 `scripts/mcd_claim.js`.
 - 已设置 Cron 任务,每日北京时间 09:30 自动触发领券并报告结果.
 - Token 归属于 Haide,已加密保存在脚本中., **快捷指令: "同步记忆"**, 触发动作:
 1. 将当前及历史聊天记录(.jsonl 文件)从系统目录备份至工作区的 `chat_backups/` 文件夹.
 2. 将整个工作区(包含记忆文件,配置及聊天备份)推送到 GitHub 私人仓库 (`HAIDEJIANG/bababot-workspace`).
 - 目的:确保本地和云端的数据一致性及安全性., **快捷指令: "请刷新领英"**, 触发动作:浏览 `https://www.linkedin.com/feed/`.
...
STS Component Solutions, 核心联系人=Nick Chambers, 业务邮箱 (Email)=`sales@sts-cs.com`, 擅长/关联 PN=J1438P020, 335-010-401-0
STS Engine Services, 核心联系人=Greg Macleod, 业务邮箱 (Email)=`greg.macleod@gt-es.co.uk`, 擅长/关联 PN=J1438P012
VSE Aviation, Inc., 核心联系人=Megan McClure, 业务邮箱 (Email)=`sales-miami@vseaviation.com`, 擅长/关联 PN=J1438P012, 2081M17P01
BROOKS & MALDINI CORP, 核心联系人=-, 业务邮箱 (Email)=`stockmarket@brooks-maldini.net`, 擅长/关联 PN=J1438P020, 335-010-401-0
SKY AIR SUPPLY LTD, 核心联系人=Brian Jones, 业务邮箱 (Email)=`sales@skyairsupply.com`, 擅长/关联 PN=J1438P012
TURBO RESOURCES INT'L, 核心联系人=Steve Donaldson, 业务邮箱 (Email)=`stevedonaldson@TurboResources.com`, 擅长/关联 PN=2081M17P01
EU INSPECTION & SERVICES, 核心联系人=-, 业务邮箱 (Email)=`maintenance@euinspectionservice.com`, 擅长/关联 PN=J1438P012
Jacaero Industries, LLC, 核心联系人=Connor Jacobs, 业务邮箱 (Email)=`connor@jacaero.com`, 擅长/关联 PN=SYS10281540
Aviation Parts, 核心联系人=-, 业务邮箱 (Email)=`sales@aviationparts.com`, 擅长/关联 PN=355A11-0030-04
AAH Parts, 核心联系人=-, 业务邮箱 (Email)=`sales@aahparts.com`, 擅长/关联 PN=8-930060-06
