...
### 2. AppleScript
- Well-documented, Mature and stable, Widely supported
...
- Missing required arguments, Task not found, Invalid date formats, OmniFocus not running
