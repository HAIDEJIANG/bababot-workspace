...
- Body text baseline: 15–18px equivalent
 ...
 - H1 = body × 2.2–2.6
 - H2 = body × 1.6–1.9
 - Line height:, Body: 1.45–1.6, Headings: 1.15–1.3, Font rule:
...
#### Color & Theme
- Palette:, 1 dominant, 1 secondary, 1 accent, 1 neutral base, Contrast:, Text ≥ 4.5:1
...
#### Background & Depth
- Background type:, Textured neutral OR, Low-contrast geometry OR, Layered planes
- Max depth layers: 3
- Foreground contrast must exceed background by ≥ 20%

#### Motion Graphics (Mandatory)
- Required motion categories:, Entry motion, Hierarchy reinforcement, Interaction feedback, Timing: 180–420ms, Easing:, Primary: ease-out
...
- Typography: 20%, Color: 20%, Layout: 20%, Motion: 15%, UX: 15%, Background: 10%
- Harmony: mandatory ≥ 8
