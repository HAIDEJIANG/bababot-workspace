...
1, Domain=Gateway Exposure, Severity= Critical, Key Question=Is the gateway bound to 0.0.0.0 without auth?
2, Domain=DM Policy, Severity=🟠 High, Key Question=Are DMs restricted to an allowlist?
3, Domain=Group Access Control, Severity=🟠 High, Key Question=Are group policies set to allowlist?
4, Domain=Credentials Security, Severity= Critical, Key Question=Are secrets in plaintext with loose permissions?
5, Domain=Browser Control Exposure, Severity=🟠 High, Key Question=Is remote browser control secured?
6, Domain=Gateway Bind & Network, Severity=🟠 High, Key Question=Is network exposure intentional and controlled?
7, Domain=Tool Access & Elevated, Severity=🟡 Medium, Key Question=Are tools restricted to minimum needed?
8, Domain=File Permissions & Disk, Severity=🟡 Medium, Key Question=Are file permissions properly set?
9, Domain=Plugin Trust & Model, Severity=🟡 Medium, Key Question=Are plugins allowlisted and models current?
10, Domain=Logging & Redaction, Severity=🟡 Medium, Key Question=Is sensitive data redacted in logs?
11, Domain=Prompt Injection, Severity=🟡 Medium, Key Question=Is untrusted content wrapped?
12, Domain=Dangerous Commands, Severity=🟡 Medium, Key Question=Are destructive commands blocked?
