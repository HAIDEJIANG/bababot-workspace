...
triggers:
 - "CEO performance", "CEORater", "CEO score", "CEO rating", "executive performance", "CEO compensation", "AlphaScore", "CompScore", "TSR", "total stock return"
metadata:
 openclaw:
 requires:
 env:
...
## Available Metrics
CEORaterScore, Range=0-100, Description=Composite CEO effectiveness rating
AlphaScore, Range=0-100, Description=Performance vs. market benchmark
RevenueCAGRScore, Range=0-100, Description=Tenure-adjusted revenue growth percentile
CompScore, Range=A-F, Description=Compensation efficiency grade
TSR During Tenure, Range=%, Description=Total Stock Return during CEO tenure
TSR vs. S&P 500, Range=%, Description=Performance relative to S&P 500 (SPY)
CEO Compensation, Range=$M, Description=Total compensation from most recent proxy filing
Revenue CAGR, Range=%, Description=Tenure-adjusted compound annual revenue growth
...
## More Information
- Documentation: https://www.ceorater.com/api-docs.html, Agent manifest: https://www.ceorater.com/.well-known/agent.json, Support: support@ceorater.com, Enterprise sales: sales@ceorater.com