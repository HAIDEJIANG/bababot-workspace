...
## Required Parameters
`from`, Type=string, Description=Sender email (must be verified)
`to`, Type=string or string[], Description=Recipient email(s)
`subject`, Type=string, Description=Email subject
`text` or `html`, Type=string, Description=Email body content
