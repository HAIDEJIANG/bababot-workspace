...
- Start Free Trial, Get Started Free, Book a Demo, Claim Your Discount, Buy Now
...
- Company size, Industry, Company names (ABM), Company growth rate
...
**What doesn't:**
- Generic stock photos, Too much text, Cluttered visuals
...
### Retargeting Windows
Hot (cart/trial), Window=1-7 days, Frequency Cap=Higher OK
Warm (key pages), Window=7-30 days, Frequency Cap=3-5x/week
Cold (any visit), Window=30-90 days, Frequency Cap=1-2x/week
