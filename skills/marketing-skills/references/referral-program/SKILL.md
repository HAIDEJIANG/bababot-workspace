...
- Motivation: Revenue/commission, Ongoing commission relationship, Requires more management
...
### Incentive Types
Cash/credit, Pros=Universally valued, Cons=Feels transactional, Best For=Marketplaces, fintech
Product credit, Pros=Drives usage, Cons=Only valuable if they'll use it, Best For=SaaS, subscriptions
Free months, Pros=Clear value, Cons=May attract freebie-seekers, Best For=Subscription products
Feature unlock, Pros=Low cost to you, Cons=Only works for gated features, Best For=Freemium products
Swag/gifts, Pros=Memorable, shareable, Cons=Logistics complexity, Best For=Brand-focused companies
Charity donation, Pros=Feel-good, Cons=Lower personal motivation, Best For=Mission-driven brands
...
- 5 referrals: T-shirt, 10 referrals: Mug, 25 referrals: Hoodie
...
- Newsletter writers, Complementary tool companies, Consultants and agencies
...
Low awareness, Likely Cause=Program not visible, Fix=Add prominent in-app prompts
Low share rate, Likely Cause=Too much friction, Fix=Simplify to one click
Low conversion, Likely Cause=Weak landing page, Fix=Optimize referred user experience
Fraud/abuse, Likely Cause=Gaming the system, Fix=Add verification, limits
One-time referrers, Likely Cause=No ongoing motivation, Fix=Add tiered/gamified rewards
...
### Prevention Measures
**Technical:**
- Email verification required, Device fingerprinting, IP address monitoring
...
- Fraud detection capabilities, Payout management, Reporting and analytics, Customization options
