...
- **Agent URL**: `https://test-agent.adcontextprotocol.org/mcp`, **Auth Token**: `1v8tAhASaUYYp4odoQ1PnMpdqNaMiTrCRqYo9OJp6IQ`, **Interactive Testing**: [testing.adcontextprotocol.org](https://testing.adcontextprotocol.org)
...
- **Task Reference**: https://docs.adcontextprotocol.org/docs/media-buy/task-reference/, **Quickstart Guide**: https://docs.adcontextprotocol.org/docs/quickstart, **Interactive Testing**: https://testing.adcontextprotocol.org
