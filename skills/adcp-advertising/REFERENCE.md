...
**Avoid vague briefs**:
- "video ads", "need advertising", "display campaign"
...
`get_adcp_capabilities`, Response Time=~1s, Reason=Simple database lookup
`list_creative_formats`, Response Time=~1s, Reason=Simple database lookup
`list_creatives`, Response Time=~1s, Reason=Simple database query
`get_products`, Response Time=~60s, Reason=AI/LLM processing for brief matching
`get_media_buy_delivery`, Response Time=~60s, Reason=Data aggregation and metric calculation
`create_media_buy`, Response Time=Minutes-Days, Reason=May require human approval
`update_media_buy`, Response Time=Minutes-Days, Reason=May require human approval
`sync_creatives`, Response Time=Minutes-Days, Reason=Creative review and validation
