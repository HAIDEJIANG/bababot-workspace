...
## The 8 Core Tasks
`get_adcp_capabilities`, Purpose=Discover agent features, Time=~1s, Auth=No
`get_products`, Purpose=Find inventory, Time=~60s, Auth=Optional
`list_creative_formats`, Purpose=View format specs, Time=~1s, Auth=No
`create_media_buy`, Purpose=Launch campaign, Time=Min-Days, Auth=Yes
`update_media_buy`, Purpose=Modify campaign, Time=Min-Days, Auth=Yes
`sync_creatives`, Purpose=Upload assets, Time=Min-Days, Auth=Yes
`list_creatives`, Purpose=Query library, Time=~1s, Auth=Yes
`get_media_buy_delivery`, Purpose=Track performance, Time=~60s, Auth=Yes
...
**Credentials:**
- URL: `https://test-agent.adcontextprotocol.org/mcp`, Token: `1v8tAhASaUYYp4odoQ1PnMpdqNaMiTrCRqYo9OJp6IQ`, Testing: [testing.adcontextprotocol.org](https://testing.adcontextprotocol.org)
...
- **Full Docs**: [SKILL.md](SKILL.md), **API Reference**: [REFERENCE.md](REFERENCE.md), **Examples**: [EXAMPLES.md](EXAMPLES.md), **Protocols**: [PROTOCOLS.md](PROTOCOLS.md), **Targeting**: [TARGETING.md](TARGETING.md), **Creatives**: [CREATIVE.md](CREATIVE.md)
