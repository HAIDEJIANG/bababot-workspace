...
type: agent
keywords:
 - advertising, ads, marketing, campaigns, adcp, programmatic, media-buying, display-ads, video-ads, facebook-ads
 - google-ads, ctv, connected-tv, marketing-automation, ad-management, campaign-optimization, roi-tracking, performance-marketing, retargeting
...
## Support
For help with AdCP:
- Official Repository: https://github.com/adcontextprotocol/adcp, Documentation: https://docs.adcontextprotocol.org, Interactive Testing: https://testing.adcontextprotocol.org
