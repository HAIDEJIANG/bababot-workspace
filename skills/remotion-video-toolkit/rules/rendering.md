...
### Available codecs
`h264`, Extension=.mp4, Use case=Default, best compatibility
`h265`, Extension=.mp4, Use case=Smaller files, less compatibility
`vp8`, Extension=.webm, Use case=Web, transparent video
`vp9`, Extension=.webm, Use case=Better quality WebM
`prores`, Extension=.mov, Use case=Professional editing (Apple ProRes)
`gif`, Extension=.gif, Use case=Short loops, social media
