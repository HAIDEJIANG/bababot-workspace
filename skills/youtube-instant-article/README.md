...
`TELEGRAPH_TOKEN`, Required=Yes, Description=Your Telegraph API access token
`OPENAI_API_KEY`, Required=Yes, Description=OpenAI API key for GPT-5.2
`SLIDES_MAX`, Required=No, Description=Default max slides (default: 6)
...
catbox.moe provides:
- No API key required
- No expiration, Reliable CDN, Simple upload API

### Why GPT-5.2?
We tested multiple models:

gpt-5.2, Speed=4.5s, Cost=$0.01, Quality=⭐ Best
gpt-4o-mini, Speed=6s, Cost=$0.0007, Quality=Good
gpt-4o, Speed=4.7s, Cost=$0.012, Quality=Good
gpt-5-nano, Speed=42s, Cost=$0.002, Quality=Slow
gemini-3-flash, Speed=timeout, Cost=—, Quality=
