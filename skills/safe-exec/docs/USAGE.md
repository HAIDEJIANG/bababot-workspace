...
## 目录
- [基础用法](#基础用法), [高级用法](#高级用法), [配置选项](#配置选项), [故障排除](#故障排除), [FAQ](#faq)
...
## 获取帮助
- **GitHub Issues**: https://github.com/yourusername/safe-exec/issues, **Discord**: https://discord.gg/clawd, **Email**: 731554297@qq.com
