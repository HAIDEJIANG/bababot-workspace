 ...
 **CRITICAL**, Detection Pattern=`rm -rf /`, Description=Delete system files
 **CRITICAL**, Detection Pattern=`dd if=`, Description=Disk destruction
 **CRITICAL**, Detection Pattern=`mkfs.*`, Description=Format filesystem
 **CRITICAL**, Detection Pattern=Fork bomb, Description=System DoS
🟠 **HIGH**, Detection Pattern=`chmod 777`, Description=Privilege escalation
🟠 **HIGH**, Detection Pattern=`curl, Description=bash`, Code injection
🟠 **HIGH**, Detection Pattern=Write to `/etc/`, Description=System config tampering
🟡 **MEDIUM**, Detection Pattern=`sudo`, Description=Privileged operations
🟡 **MEDIUM**, Detection Pattern=Firewall modification, Description=Network exposure
 ...
 **Cannot prevent:**
- Already compromised systems, Direct hardware operations, Social engineering attacks
