...
`source`, Type=string[], Description=Platforms: twitter, reddit, github, linkedin, youtube, hackernews, devto, stackoverflow, bluesky, newsletter, podcast
`sentiment`, Type=string[], Description=Values: positive, neutral, negative
`keyword`, Type=string[], Description=Keyword IDs (get from /keywords endpoint)
`language`, Type=string[], Description=ISO 639-1 codes: en, es, fr, de, pt, it, nl, ja, ko, zh
`tag`, Type=string[], Description=Tag names
`bookmarked`, Type=boolean, Description=Filter bookmarked (true) or non-bookmarked (false) posts
`engaged`, Type=boolean, Description=Filter engaged (true) or non-engaged (false) posts
`minXFollowers`, Type=number, Description=Minimum Twitter follower count
`maxXFollowers`, Type=number, Description=Maximum Twitter follower count
`startDate`, Type=string, Description=ISO 8601 format (e.g., "2024-01-15T00:00:00Z")
...
## Error Handling
401, Error=unauthorized, Description=Missing or invalid API key
403, Error=forbidden, Description=Valid key but no permission
404, Error=not_found, Description=Resource (e.g., view ID) not found
429, Error=rate_limit_exceeded, Description=Too many requests
400, Error=invalid_request, Description=Malformed request body
500, Error=internal_error, Description=Server error, retry later
