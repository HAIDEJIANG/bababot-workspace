...
2. **Session Handoff**: Automatic new session with:
 - User context (USER.md), Project memory (MEMORY.md), Compressed session summary, Current working state
...
- Configuration changes, New files created, Deleted files, Directory structure changes
