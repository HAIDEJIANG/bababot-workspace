...
## Supported Sites
Paul Graham, Key=`paulgraham`, URL Pattern=paulgraham.com/articles.html
Kevin Kelly, Key=`kevinkelly`, URL Pattern=kk.org/thetechnium
Derek Sivers, Key=`sivers`, URL Pattern=sive.rs/blog
Wait But Why, Key=`waitbutwhy`, URL Pattern=waitbutwhy.com/archive
Astral Codex Ten, Key=`acx`, URL Pattern=astralcodexten.com
