...
- Hide rarely-used options, Simplify language, Reduce color/visual noise
...
- Auto-save, Auto-fill, Smart suggestions, Error prevention

### 4. Support Scanning
- Clear headings, Bullet points, Visual hierarchy, Whitespace

### 5. Reduce Decisions
- Smart defaults, Recommendations, Limited choices, Clear primary action
