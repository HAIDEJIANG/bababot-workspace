...
- Secondary navigation, Settings/admin menus, Large navigation structures
...
- Mobile navigation works:, Keyboard navigation supported:, Deep linking possible:, Consistent across pages:, Active states clear: