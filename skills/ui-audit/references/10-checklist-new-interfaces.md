...
- Different layouts, Different navigation approaches, Different information hierarchies, Different interaction patterns
...
- Empty states, Minimal content, Maximum/overflow content, Edge cases

 **Is system feedback clear?**
- Loading states, Success/error feedback, Progress indicators

 **Is user input handled?**
- Validation states, Error messages, Help text

 **Is navigation complete?**
- All pages/views connected, Back navigation, Deep linking
...
1. Define System, Focus=Platform, constraints, data, Output=System requirements doc
2. Model Tasks, Focus=Users, workflows, entities, Output=Task flows, CRUD maps
3. Organize Info, Focus=Categories, hierarchy, nav, Output=Information architecture
4. Gather Inspiration, Focus=Research, patterns, references, Output=Moodboard, pattern library
5. Generate Ideas, Focus=Divergent exploration, Output=6+ wireframe concepts
6. Enhance Fidelity, Focus=Detail, polish, edge cases, Output=High-fi designs, prototypes
