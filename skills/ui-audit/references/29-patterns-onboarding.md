...
**Tooltips**, Trigger=Hover/focus, Example=Icon explanations
**Coach marks**, Trigger=First visit to area, Example=Feature introduction
**Hotspots**, Trigger=Available anytime, Example=Pulsing indicator for help
**Inline hints**, Trigger=Contextual, Example=Empty state guidance
...
- Repeat dismissed tips, Block interaction, State the obvious
...
- Show irrelevant features, Repeat already-learned content, Ignore user progress, Rush to "completion"
