...
- Shopping cart: Checkout, Inbox: Messages, Library: Content collection, Dashboard: Metrics overview, Workspace: Project environment
...
### Decision Framework
Time available, Lower Originality=Limited, Higher Originality=Ample
Risk tolerance, Lower Originality=Low, Higher Originality=High
User sophistication, Lower Originality=General, Higher Originality=Early adopters
Market maturity, Lower Originality=Established, Higher Originality=Emerging
Differentiation need, Lower Originality=Low, Higher Originality=Critical
Pattern clarity, Lower Originality=Clear best practice, Higher Originality=No clear winner
...
- Unexpected discoveries, Principles that emerged, Recommendations for future
