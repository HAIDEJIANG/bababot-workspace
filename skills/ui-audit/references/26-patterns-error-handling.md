...
**On blur**, Pros=Good balance, validates after field, Cons=Slight delay
**On submit**, Pros=Simple to implement, Cons=Errors appear late
**Real-time**, Pros=Immediate feedback, Cons=Can be annoying
**Debounced**, Pros=Good for async checks, Cons=Timing tuning needed
...
**Draft preservation:**
- Auto-save drafts, Recover unsaved work, Version history
...
### Error Types
**User error**, Tone=Helpful, not blaming, Recovery Options=Explain how to fix
**System error**, Tone=Apologetic, Recovery Options=Retry, contact support
**Network error**, Tone=Informative, Recovery Options=Retry when connected
**Permission error**, Tone=Clear, Recovery Options=Request access, explain why
