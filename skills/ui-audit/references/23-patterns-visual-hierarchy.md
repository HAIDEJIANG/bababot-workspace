...
### Hierarchy Levels
**Display**, Purpose=Hero content, page title, Typical Treatment=Largest, boldest
**H1**, Purpose=Page heading, Typical Treatment=Large, bold
**H2**, Purpose=Section heading, Typical Treatment=Medium-large, semibold
**H3**, Purpose=Subsection, Typical Treatment=Medium, semibold
**Body**, Purpose=Primary content, Typical Treatment=Base size, regular
**Secondary**, Purpose=Supporting text, Typical Treatment=Smaller, lighter color
**Caption**, Purpose=Labels, metadata, Typical Treatment=Smallest, light
...
- Disabled: Light gray, Destructive: Red family, Success: Green family
...
### Creating Focus
**High contrast for:**
- Primary CTAs, Important information, Error states, Current/active states

**Low contrast for:**
- Secondary actions, Supporting text, Disabled states, Background elements
...
- Primary action obvious:, Related items grouped:, Unrelated items separated:, Reading flow logical:
