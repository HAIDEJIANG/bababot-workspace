...
- [React Email Documentation](https://react.email/docs/llms.txt), [React Email GitHub](https://github.com/resend/react-email), [Resend Documentation](https://resend.com/docs/llms.txt)
- [Email Client CSS Support](https://www.caniemail.com)
- Component Reference: [references/COMPONENTS.md](references/COMPONENTS.md), Internationalization Guide: [references/I18N.md](references/I18N.md), Common Patterns: [references/PATTERNS.md](references/PATTERNS.md)