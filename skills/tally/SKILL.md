...
## Endpoints
List forms, Method=GET, Endpoint=`https://api.tally.so/forms`
Get form, Method=GET, Endpoint=`https://api.tally.so/forms/{id}`
Update form, Method=PATCH, Endpoint=`https://api.tally.so/forms/{id}`
Get submissions, Method=GET, Endpoint=`https://api.tally.so/forms/{id}/submissions`
