...
## Webhook Limits
Free, Payload Size=**2 KB** (2,048 bytes), Rate Limit=12 requests/hour
TRMNL+, Payload Size=**5 KB** (5,120 bytes), Rate Limit=30 requests/hour
...
- `value--xxxlarge`: Hero KPIs, `value--xxlarge`: Large prices, `value--xlarge`: Secondary metrics, `value--small`: Tertiary data
