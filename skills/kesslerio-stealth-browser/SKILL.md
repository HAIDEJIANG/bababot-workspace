...
## Tool Selection
**Browser**, Tool=Camoufox, When to Use=All protected sites - Cloudflare, Datadome, Yelp, Airbnb
**API Only**, Tool=curl_cffi, When to Use=No browser needed, just TLS spoofing
