...
## Troubleshooting
403 immediately, Cause=Datacenter IP, Fix=Use residential
403 after few requests, Cause=IP burned, Fix=Rotate to new IP
Captcha appears, Cause=Suspicious behavior, Fix=Slow down, add randomness
Connection timeout, Cause=Bad proxy, Fix=Try different proxy/provider
SSL errors, Cause=Proxy doesn't support HTTPS, Fix=Use HTTPS proxy or tunnel