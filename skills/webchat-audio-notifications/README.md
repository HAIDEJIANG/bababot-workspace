...
Chrome, Version=92+, Support= Full, Notes=Strictest autoplay policy
Firefox, Version=90+, Support= Full, Notes=Slightly more permissive
Safari, Version=15+, Support= Full, Notes=Requires WebKit prefixes (handled)
Edge, Version=92+, Support= Full, Notes=Chromium-based
Mobile Chrome, Version=Latest, Support=️ Limited, Notes=Requires user gesture per play
Mobile Safari, Version=Latest, Support=️ Limited, Notes=iOS restrictions apply
