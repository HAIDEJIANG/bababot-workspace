...
## API Keys Required
ElevenLabs, Purpose=Text-to-speech, Link=https://elevenlabs.io
Supadata, Purpose=YouTube transcripts, Link=https://supadata.ai
OpenRouter, Purpose=AI summarization, Link=https://openrouter.ai
