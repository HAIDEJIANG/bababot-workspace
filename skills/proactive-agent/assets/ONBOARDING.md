...
1, Question=Name, Answered=, Source=—
2, Question=Timezone, Answered=, Source=—
3, Question=Communication style, Answered=, Source=—
4, Question=Pet peeves, Answered=, Source=—
5, Question=Primary goal, Answered=, Source=—
6, Question=1-year vision, Answered=, Source=—
7, Question=Ideal life, Answered=, Source=—
8, Question=Productivity time, Answered=, Source=—
9, Question=Async vs real-time, Answered=, Source=—
10, Question=Current projects, Answered=, Source=—
11, Question=Key people, Answered=, Source=—
12, Question=Agent personality, Answered=, Source=—
