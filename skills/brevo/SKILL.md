...
### Contacts
Create contact, Method=POST, Endpoint=`/contacts`
Get contact, Method=GET, Endpoint=`/contacts/{email}`
Update contact, Method=PUT, Endpoint=`/contacts/{email}`
Delete contact, Method=DELETE, Endpoint=`/contacts/{email}`
List contacts, Method=GET, Endpoint=`/contacts?limit=50&offset=0`
Get blacklisted, Method=GET, Endpoint=`/contacts?emailBlacklisted=true`
