...
Public, URL Pattern=`/.well-known/agent-card`, Discoverability=Anyone can find it
Professional, URL Pattern=`/.well-known/agent-card/{name}`, Discoverability=Discoverable if you know the name
Private, URL Pattern=`/{random-uuid}/agent-card.md`, Discoverability=Only people you give the URL to
