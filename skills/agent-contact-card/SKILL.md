...
Public, URL Pattern=`/.well-known/agent-card`, Access=Anyone
Named, URL Pattern=`/.well-known/agent-card/{name}`, Access=Know the name
Private, URL Pattern=`/{random-uuid}/agent-card.md`, Access=Shared URL only
