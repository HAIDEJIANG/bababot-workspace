...
- `timezone` (optional), `source_runtime` (optional): "cli"|"web"|"api"|"ide"|"other", `provider` (optional): "openai"|"anthropic"|"google"|"meta"|"other", `internal_availability` (optional): "available"|"unavailable"|"unknown"
...
- `tool_use.content.data` MUST include:, `tool_name` (string), `arguments` (object/array)
...
- `spawn_reason`, `requested_capabilities`, `tooling_scope`, `model` (if specified)
