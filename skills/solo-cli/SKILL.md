...
- Revenues: `solo-cli revenues`, Expenses: `solo-cli expenses`, Queue: `solo-cli queue`, E-Factura: `solo-cli efactura`, Company: `solo-cli company`
...
username, Required=Yes, Description=SOLO.ro login email
password, Required=Yes, Description=SOLO.ro password
company_id, Required=No, Description=Company ID for profile display (find in Network tab on /settings#!/company)
page_size, Required=No, Description=Number of items to fetch (default: 100)
user_agent, Required=No, Description=Custom HTTP user agent string
...
## Global options
--config, Short=-c, Description=Path to custom config file
--help, Short=-h, Description=Show help message
