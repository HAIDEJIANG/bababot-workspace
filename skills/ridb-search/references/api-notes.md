...
`latitude`, Type=float, Description=Center point latitude
`longitude`, Type=float, Description=Center point longitude
`radius`, Type=int, Description=Miles from center
`limit`, Type=int, Description=Max results (default 50)
`offset`, Type=int, Description=Pagination offset
`activity`, Type=string, Description=Activity ID filter (9 = Camping)
`query`, Type=string, Description=Text search

## Activity IDs (Common)
- 9: Camping, 14: Hiking, 5: Biking, 11: Fishing, 25: Swimming
