...
Contact Read, Trial Account= Working, Paid Account= Working
Contact Create/Update, Trial Account= Working, Paid Account= Working
Deal Create, Trial Account= Blocked, Paid Account= Working
Deal List, Trial Account= Working, Paid Account= Working
Pipeline List, Trial Account= Blocked, Paid Account= Working
Tag Add/Create, Trial Account= Blocked, Paid Account= Working
Lists List, Trial Account= Blocked, Paid Account= Working
